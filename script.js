...
var SKILLS = {
  lamp: [
    ...
    },
    {
      ...
      desc: 'Completion is <em>invisible</em> to vision. The bulb reaches the mechanical stop only detectable as a sharp increase in shear force via tactile sensors.',
  ...
  bottle: [
    ...
    },
    {
      ...
      desc: 'Visual navigation to the bottle neck. Position of the bottle opening is estimated from RGB and tactile contact onset to confirm seating.',
    ...
    },
    {
      ...
      desc: 'Fine alignment uses both visual positioning and tactile seating pattern',
      video: 'videos/align bottle cap.mp4',
      tac1: 'videos/align_bottle_cap_tactile1.mp4', tac2: 'videos/align_bottle_cap_tactile2.mp4'
    },
    {
      name: 'Slide Cap', mod: 'T', ptype: 'Disc.',
      terminal: 'Cap slides until slippage is detected.',
      desc: 'The most tactile-dominant skill. Slippage — a transient force pattern — must be detected from FeelAnyForce tokens. From visual prespective it\'s just a repetative slide motion.',
  ...
  blind: [
    ...
    },
    {
      ...
      ringColor: '#e03030', nodeClass: 'node-failed', label: 'Cube not found'
    },
    {
    ...
    },
    {
      ...
      desc: 'Visual guidance to the second candidate box, conditioned on the earlier withdraw stored in event memory.',
    ...
    },
    {
      ...
      nodeClass: 'node-success', label: 'Cube found!'
    },
    {
  ...
  skills.forEach(function (sk, i) {
    ...
    node.innerHTML =
      '<div class="tnode-circle">' +
        ...
        '</svg>' +
      '</div>' +
      (sk.label ? '<span class="tnode-outcome-label">' + sk.label + '</span>' : '') +
